...
class MultiDistillationMetaArch(CAMMetaArch):
    """
    Multidistillation version of CAMMetaArchCompilableGram:
    ...
    def get_teacher_output(
        ...
        *,
        ...
        cls_after_head = self.teacher.cam_head(cls, no_last_layer=True)  # [n_crops * B, K]
        ...
        cls_after_head = self.teacher.cam_head(cls_after_head, only_last_layer=True)  # [n_crops * B, K]
        # End of multidistillation codepath
