...
def get_params_groups_with_decay(model, lr_decay_rate=1.0, patch_embed_lr_mult=1.0, cam_head_wd_multiplier=1.0):
    chunked_blocks = False
    ...
    for name, param in model.named_parameters():
        ...
        if "cam_head" in name:
            d["wd_multiplier"] = cam_head_wd_multiplier
...
def get_params_groups_with_decay_fsdp(model, lr_decay_rate=1.0, patch_embed_lr_mult=1.0, cam_head_wd_multiplier=1.0):
